...
function DeliveryResults(props) {
  ...
  const tabsSuccess = () => {
    return (
      <div style={{ width: "95%" }}>
        <Form.Item
          rules={!tabsKey ? [validate.checkRequire("tên người nhận")] : ""}
          name="receiver"
          label="Người nhận"
        >
          <Input
            ...
            !tabsKey
              ? [
                  validate.checkRequire(
                    "quan hệ với người nhận hoặc 'Chính Chủ' "
                  ),
                ]
              : ""
          }
        ...
        <Form.Item
          rules={
            !tabsKey ? [validate.checkRequire("giấy tờ hoặc 'Không Có' ")] : ""
          }
          name="exhibit"
          label="Giấy tờ"
        >
        ...
        <Form.Item
          rules={!tabsKey ? [validate.checkRequire("số tiền")] : ""}
          name="collectMoney"
          label="Tiền thu"
        >
          <Input
          ...
          <Row gutter={[48, 20]}>
            <Col md={24}>
              <div className="inFoPost">
                <Form.Item
                  name="postman"
                  rules={[validate.checkRequire("tên người bưu tá")]}
                  label="Bưu tá:"
                >
                  <Select
                    showSearch
                ...
                <Form.Item
                  name="timedate"
                  rules={[validate.checkRequire("ngày và giờ phát")]}
                  label="Ngày giờ phát:"
                >
                  <DatePicker
                    onChange={(e) => {
            ...
            <Col xs={24} md={24}>
              <div className="stepForm">
                ...
                >
                  ...
                  <TabPane
                    tab={
                      <span style={{ color: "#CD1818", lineHeight: "19px" }}>
